...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center">
    ...
    <p class="text-sm text-gray-400 mb-6">Enter your M-Pesa PIN to pay <span class="text-green-700 font-semibold">Ksh 100</span></p>

    <div class="bg-green-800 text-white rounded-xl p-4 text-left mb-6">
        <p class="font-semibold text-sm mb-1">M-PESA</p>
        <p class="text-xs opacity-80">Pay Ksh 100.00 to MASTERCLASS EVENTS for account REG-{{ $registration->id }}? Enter PIN to confirm.</p>
    </div>

    <div id="countdown" class="text-sm text-gray-400 mb-4">
        Prompt expires in <span id="timer" class="font-semibold text-gray-700">30</span>s
    </div>
